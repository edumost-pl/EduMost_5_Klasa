(function () {
  var KEY = "fragment";
  var SCANS = [
    { src: "../71-tulaczka-odyseusza/t71-tekst-148.jpg", label: "s. 148", alt: "Parandowski — Tułaczka Odyseusza (s. 148)" },
    { src: "../71-tulaczka-odyseusza/t71-tekst-149.jpg", label: "s. 149", alt: "Parandowski — Tułaczka Odyseusza (s. 149)" },
    { src: "../71-tulaczka-odyseusza/t71-tekst-150.jpg", label: "s. 150", alt: "Parandowski — Tułaczka Odyseusza (s. 150)" },
    { src: "../71-tulaczka-odyseusza/t71-tekst-151.jpg", label: "s. 151", alt: "Parandowski — Tułaczka Odyseusza (s. 151)" },
    { src: "../71-tulaczka-odyseusza/t71-tekst-152.jpg", label: "s. 152", alt: "Parandowski — Tułaczka Odyseusza (s. 152)" },
    { src: "../71-tulaczka-odyseusza/t71-tekst-153.jpg", label: "s. 153", alt: "Parandowski — Tułaczka Odyseusza (s. 153)" },
    { src: "../71-tulaczka-odyseusza/t71-tekst-154.jpg", label: "s. 154", alt: "Parandowski — Tułaczka Odyseusza (s. 154)" },
    { src: "../71-tulaczka-odyseusza/t71-tekst-155.jpg", label: "s. 155", alt: "Parandowski — Tułaczka Odyseusza (s. 155)" },
    { src: "../71-tulaczka-odyseusza/t71-tekst-156.jpg", label: "s. 156", alt: "Parandowski — Tułaczka Odyseusza (s. 156)" }
  ];
  var VER = "t72b";
