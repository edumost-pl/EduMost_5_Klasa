(function () {
  var KEY = "fragment";
  var SCANS = [
    { src: "./t70-tekst-1.jpg", label: "s. 143", alt: "Ceram — Bajka o biednym chłopcu (s. 143)" },
    { src: "./t70-tekst-2.jpg", label: "s. 144", alt: "Ceram — Amsterdam, języki, Grecja (s. 144)" },
    { src: "./t70-tekst-3.jpg", label: "s. 145", alt: "Ceram — Hissarlik, Zofia, wykopaliska (s. 145)" },
    { src: "./t70-tekst-4.jpg", label: "s. 146", alt: "Ceram — dziewięć miast, skarb Priama (s. 146)" },
    { src: "./t70-troja.jpg", label: "Ruiny Troi", alt: "Fotografia: Ruiny Troi" }
  ];
  var VER = "t70b";
  ...
  function mount() {
    ...
    pane.setAttribute("aria-label", "Fragment Ceram — strony s. 143–146");
