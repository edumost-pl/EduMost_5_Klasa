(function () {
  var KEY = "wiersz";
  var SCANS = [
    { src: "./t68-wiersz.png", label: "s. 138 · wiersz", alt: "Zofia Beszczyńska — podróże" }
  ];
  ...
  function mount() {
    ...
    gal.setAttribute("aria-label", "Wiersz Beszczyńskiej");
    SCANS.forEach(function (scan, i) {
      ...
      fig.innerHTML =
        ...
        "<img class=\"viz-img\" src=\"" + scan.src + "?v=t68a\" alt=\"" + scan.alt +
